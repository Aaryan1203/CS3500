...
public class EuropeanSolitaireModelTest {
  ...
  MarbleSolitaireModel boardThree = new EuropeanSolitaireModel();
  MarbleSolitaireModel boardFive = new EuropeanSolitaireModel(5);
  MarbleSolitaireModel boardFourFour = new EuropeanSolitaireModel(4, 4);
  MarbleSolitaireModel boardSeven = new EuropeanSolitaireModel(7, 10, 6);
  ...
  public void testThreeArgumentConstructor() {
    ...
    assertEquals(276, boardSeven.getScore());
    ...
    assertEquals(SlotState.Marble, boardSeven.getSlotAt(5, 5));
    assertEquals(SlotState.Marble, boardSeven.getSlotAt(13, 13));
    assertEquals(SlotState.Marble, boardSeven.getSlotAt(5, 13));
    assertEquals(SlotState.Marble, boardSeven.getSlotAt(13, 5));
    ...
    // Error test here
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(8, 10, 6);
      fail("No exception thrown for invalid thickness");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(8, -3, -3);
      fail("No exception thrown for invalid thickness, sRow, or sCol");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(1, -3, -3);
      fail("No exception thrown for invalid thickness, sRow, or sCol");
    } catch (Exception e) {
      // works as expected
    }
    ...
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(7, -4, 2);
      fail("No exception thrown for invalid sRow");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(7, 0, 0);
    ...
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(5, 4, 14);
  ...
  public void testOneArgumentConstructor() {
    ...
    assertEquals(128, boardFive.getScore());
    ...
    assertEquals(SlotState.Marble, boardFive.getSlotAt(9, 9));
    assertEquals(SlotState.Marble, boardFive.getSlotAt(3, 9));
    assertEquals(SlotState.Marble, boardFive.getSlotAt(9, 3));
    ...
    // Error test here
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(10);
      fail("No exception thrown for odd thickness");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(1);
      fail("No exception thrown for invalid thickness");
    } catch (Exception e) {
      // works as expected
    }
  ...
  public void testTwoArgumentConstructor() {
    ...
    assertEquals(36, boardFourFour.getScore());
    ...
    assertEquals(SlotState.Marble, boardFourFour.getSlotAt(5, 5));
    assertEquals(SlotState.Marble, boardFourFour.getSlotAt(1, 5));
    assertEquals(SlotState.Marble, boardFourFour.getSlotAt(5, 1));
    ...
    // Error test here
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(-2, 3);
      fail("No exception thrown for invalid sRow");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(2, -4);
      fail("No exception thrown for invalid sCol");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(8, 3);
      fail("No exception thrown for invalid sRow");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(2, 9);
      fail("No exception thrown for invalid sCol");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(5, 6);
      fail("No exception thrown for invalid sRow and sCol");
    } catch (Exception e) {
      // works as expected
    }
    try {
      EuropeanSolitaireModel boardSeven = new EuropeanSolitaireModel(0, 0);
      fail("No exception thrown for invalid sRow and sCol");
    } catch (Exception e) {
      // works as expected
    }
  ...
  public void testNoArgumentConstructor() {
    ...
    assertEquals(36, boardThree.getScore());
    ...
    assertEquals(SlotState.Marble, boardThree.getSlotAt(5, 5));
    assertEquals(SlotState.Marble, boardThree.getSlotAt(1, 5));
    assertEquals(SlotState.Marble, boardThree.getSlotAt(5, 1));
  ...
  public void testMove() {
    ...
    assertEquals(35, boardThree.getScore());
    ...
    assertEquals(127, boardFive.getScore());
    ...
    assertEquals(35, boardFourFour.getScore());
    ...
    assertEquals(275, boardSeven.getScore());
  ...
  public void testGetSlotAt() {
    ...
    assertEquals(SlotState.Marble, boardFive.getSlotAt(10, 10));
    assertEquals(SlotState.Marble, boardFive.getSlotAt(8, 9));
    ...
    assertEquals(SlotState.Invalid, boardSeven.getSlotAt(0, 0));
    assertEquals(SlotState.Marble, boardSeven.getSlotAt(3, 3));
    assertEquals(SlotState.Empty, boardSeven.getSlotAt(10, 6));
  ...
  public void testGetScore() {
    ...
    assertEquals(35, boardThree.getScore());
    boardThree.move(1, 2, 3, 2);
    assertEquals(34, boardThree.getScore());

    assertEquals(128, boardFive.getScore());
    boardFive.move(6, 4, 6, 6);
    assertEquals(127, boardFive.getScore());
    boardFive.move(4, 5, 6, 5);
    assertEquals(126, boardFive.getScore());

    assertEquals(36, boardFourFour.getScore());
    boardFourFour.move(4, 2, 4, 4);
    assertEquals(35, boardFourFour.getScore());
    boardFourFour.move(2, 3, 4, 3);
    assertEquals(34, boardFourFour.getScore());

    assertEquals(276, boardSeven.getScore());
    boardSeven.move(8, 6, 10, 6);
    assertEquals(275, boardSeven.getScore());
    boardSeven.move(6, 6, 8, 6);
    assertEquals(274, boardSeven.getScore());
  }
